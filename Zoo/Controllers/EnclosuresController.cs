...
namespace Zoo.Controllers
{
    public class EnclosuresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Climate,Habitat,SecurityRequired,Size")] Enclosure enclosure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Climate,Habitat,SecurityRequired,Size")] Enclosure enclosure)
        {
            if (id != enclosure.Id)
            {
                return NotFound();
